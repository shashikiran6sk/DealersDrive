...
| ----- | ------------------------------------ | ------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------------------------------------- |
| C040  | `OnboardingWizard`                   | `features/auth/onboarding-wizard.tsx:57`    | `step`, `session`, `documents`, `dealer`, `completeness`, `yardPhoto` — ⚠️ `cities` removed by **D6**       | 4 steps × valid/invalid/submitting, name-taken, business-with-description, changes-requested (×2)                                                                                | F037–F043 | **P0** ✅                                 |
...
| C044  | `DealerProfileForm`                  | `features/dealer/profile-form.tsx:39`       | `dealer: DealerProfile`                                                                                     | populated, sparse, saved, field refusal, server error, saving                                                                                                                    | F046      | **P1** ✅                                 |
...
| C062c | `DealerProfileEditor`                | `features/admin/dealer-profile-editor.tsx`  | `dealer: AdminDealerDetail`                                                                                 | reading, with gaps, editing, read-only seat, saving, server refusal                                                                                                              | F045      | **P0** ✅                                 |
