...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    ownership: 'Feature-specific',
    purpose:
      "The header's district button. Chooses the area; the directory's chips choose the town.",
    aliases: [
      'CitySelector',
      'DistrictSelector',
      'LocationPicker',
    ...
    features: ['F085', 'F086'],
    props: ['locations'],
    states: ['all districts', 'one chosen', 'open', 'no districts', 'many districts'],
    reusable: false,
