...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    states: [
      ...
      'server error',
      'saving',
      'change waiting for review — the two boxes are locked',
      'cancelling',
      'cancel refused',
      'change refused — the boxes are open again',
    ],
    reusable: false,
  ...
  },
  {
    ...
    ownership: 'Shared',
    purpose:
      'The services list, one at a time, as removable chips. NEW at R37 — replaces the comma-separated box on both screens that write `specialities`.',
    aliases: [
      'ServiceTokenInput',
      'ChipInput',
      'TokenInput',
    ...
    states: [
      ...
      'duplicate refused',
      'at the 12 limit',
      'disabled (R34 waiting for review)',
      'aria-invalid',
    ],
    reusable: true,
  ...
  },
  {
    ...
    ownership: 'Shared',
    purpose:
      'One box per digit of a verification code. NEW at R39 — auto-advance, Backspace steps back, and a pasted or autofilled code spreads across every box rather than crowding the first.',
    aliases: [
      'Otp',
      'OTP',
      'OtpBoxes',
  ...
  },
  {
    ...
    ownership: 'Feature-specific',
    purpose:
      "Onboarding step 1's mobile check, in four states. NEW at R39 — runs the MSG91 OTP widget in the browser and believes only the API's verdict on the token it produces. Carries the step's forward action, because the design puts it in three different places across three states.",
    aliases: [
      'PhoneOtp',
      'OtpVerification',
      'MobileVerification',
    ...
    reusable: false,
    storyId: 'forms-phoneverification',
  },
];
