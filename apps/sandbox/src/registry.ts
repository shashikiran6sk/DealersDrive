...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    purpose:
      'The mobile number, proved by a Firebase OTP. NEW at R39 — replaces the plain phone box on onboarding step 1. Not a sign-in: Google remains the dealer door.',
    aliases: [
      'OtpInput',
      'OTP',
      'PhoneInput',
    ...
    features: ['R39', 'F037'],
    props: ['firebase', 'initialPhone', 'initialPhoneDisplay', 'verified', 'error'],
    states: [
      'empty',
      'prefilled',
      'code sent',
