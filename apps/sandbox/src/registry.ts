...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    ...
    category: 'Admin',
    ownership: 'Feature-specific',
    purpose: 'Approve or suspend a dealership. The API says which is offered, not this.',
    aliases: [
      'DealerActions',
      'AdminDealerActions',
      'ApproveDealer',
    ...
    features: ['F045'],
    props: ['dealer'],
    states: ['pending ready', 'pending unverified', 'active', 'suspended', 'rejected', 'in flight', 'server error'],
    reusable: false,
  ...
  },
  {
    ...
    category: 'Primitives',
    ownership: 'Primitive',
    purpose: 'The .table class as a component, scroll container included. NEW at F045 — finding D-B.',
