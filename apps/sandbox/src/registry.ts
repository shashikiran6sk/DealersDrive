...
export const registry: RegistryEntry[] = [
  ...
  },
  {
    id: 'C042',
    name: 'AdminLoginForm',
    source: 'apps/web/src/features/auth/admin-login-form.tsx',
    category: 'Forms',
    ownership: 'Feature-specific',
    purpose: 'Email and password for platform staff, submitted to a Server Action.',
    aliases: ['AdminLogin', 'StaffLoginForm', 'PasswordLoginForm', 'admin-login-form'],
    features: ['F019'],
    props: ['initialMessage'],
    states: ['idle', 'server error', 'field errors', 'submitting', 'session expired'],
    reusable: false,
    storyId: 'forms-adminloginform',
  },
  {
    id: 'C043',
    name: 'SignOutButton',
