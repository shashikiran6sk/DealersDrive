...
/*
 * ── Reconstruction note ─────────────────────────────────────────────────────
 * `readOAuthCookie`, `setOAuthCookie` and `clearOAuthCookie` live here in the
 * baseline. They read and write OAUTH_COOKIE, a constant owned by
 * oauth-transaction.ts, which is F018. They return with it.
 */
